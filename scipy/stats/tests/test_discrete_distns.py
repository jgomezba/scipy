...
def test_issue_22618():
    # Test for issue #22618 reported by AlexanderFabisch.

    n = 10000
    p = 4e-5
    q = 1e-20  # Extremely small probability

    expected_upper_bound = 16  # Expected result based on binom.sf

    result = binom.isf(q, n, p)

    assert result <= expected_upper_bound
